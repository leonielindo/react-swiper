    ...
    return {
        visitor: {
            CallExpression(path, _ref2) {
                ...
                // Get webpack config
                const conf = getConfig(configPath ? [configPath].concat(DEFAULT_CONFIG_NAMES) : DEFAULT_CONFIG_NAMES, findConfig);
...
function getConfig(configPaths, findConfig) {
    ...
    (0, _lodash4.default)(configPaths, configPath => {
        ...
        if (!findConfig) {
            // Get webpack config
            conf = require((0, _path.resolve)(process.cwd(), compiledConfigPath));
        } else {
            conf = require(_findUp2.default.sync(compiledConfigPath));
        }
